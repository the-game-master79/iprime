...
export const Hero = ({ badge, badges, description, action }: HeroProps) => {
  const { user } = useAuth();
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="w-full flex flex-col items-center md:items-start text-center md:text-left">
            <h1 className="text-6xl md:text-8xl font-black tracking-tight leading-tight bg-clip-text text-transparent bg-gradient-to-br from-primary via-foreground to-foreground/80 drop-shadow-2xl mb-3 animate-fade-in-up">
              Institutional Power.
            </h1>
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight leading-tight text-foreground/90 mb-6 animate-fade-in-up delay-100">
              Retail Access.
            </h2>
