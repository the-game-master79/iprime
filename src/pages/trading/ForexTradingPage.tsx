...
const ForexTradingPage = () => {
  return (
    <>
      <Helmet>
        <title>Forex Trading Online | Best Forex Brokers | Arthaa</title>
        <meta name="description" content="Trade forex online with the best forex brokers. Enjoy tight spreads, fast execution, and advanced trading tools on Arthaa." />
        <link rel="canonical" href="https://www.arthaa.pro/trading/forex" />
      </Helmet>
      <PageTransition>
