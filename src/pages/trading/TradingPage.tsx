...
const TradingPage = () => {
  return (
    <>
      <Helmet>
        <title>Best Automated Trading Platform for Smart Trading | Arthaa</title>
        <meta name="description" content="Arthaa offers the best automated trading platform for smart, AI-powered trading. Enhance your strategies and trade efficiently with advanced tools." />
