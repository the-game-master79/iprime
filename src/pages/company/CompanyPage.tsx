...
const CompanyPage = () => {
  return (
    <>
      <Helmet>
        <title>About Arthaa | Our Mission & Values</title>
        <meta name="description" content="Learn about Arthaa's mission, journey, and values that drive us to empower traders worldwide. Discover our story and commitment to excellence." />
        <link rel="canonical" href="https://www.arthaa.pro/company" />
      </Helmet>
      <PageTransition>
