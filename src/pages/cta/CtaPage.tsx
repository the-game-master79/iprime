...
export const CtaPage = () => {
  return (
    <section className="relative overflow-hidden border-t border-border/50">
      ...
      <div className="absolute inset-y-0 right-0 -z-10 w-[32rem] bg-gradient-to-l from-primary/5 to-transparent" />
      <div className="absolute inset-y-0 left-0 -z-10 w-[32rem] bg-gradient-to-r from-primary/5 to-transparent" />
