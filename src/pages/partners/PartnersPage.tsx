...
const PartnersPage = () => {
  return (
    <>
      <Helmet>
        <title>Partner Program | Earn with Arthaa</title>
        <meta name="description" content="Join the Arthaa partner program and earn substantial commissions. Help others discover professional trading and benefit from our multi-tier commission structure." />
        <link rel="canonical" href="https://www.arthaa.pro/partners" />
      </Helmet>
      <PageTransition>
