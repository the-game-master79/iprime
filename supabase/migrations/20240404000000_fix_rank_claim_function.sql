-- Drop and recreate the rank claim function with correct status value
...
BEGIN
    ...
    BEGIN
        ...
        -- Create transaction record with correct status
        INSERT INTO transactions (
            ...
            rank_bonus,
            'rank_bonus',
            'Completed',  -- Using correct status that matches the constraint
...
-- Update any existing rank bonus transactions to match constraint
UPDATE transactions 
