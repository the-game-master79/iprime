...
-- Add updated check constraint with rank_bonus type
ALTER TABLE transactions 
ADD CONSTRAINT transactions_type_check 
CHECK (type IN ('deposit', 'withdrawal', 'commission', 'investment', 'adjustment', 'rank_bonus', 'investment_return'));

-- Update claim_rank_bonus function to match constraint
